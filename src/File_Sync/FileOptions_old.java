...
public class FileOptions_old {

	public FileOptions_old(File fromPath, File fromFilename, File toPath,
			File toFilename) {
	 ...
	 * System.err.println( "Usage: java FileCopy <src> <dest>" ); else copyFile(
	 * args[0], args[1] ); }
	 */
